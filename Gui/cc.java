...
public class cc extends javax.swing.JFrame {
    ...
    public void loadunbanked() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `check` INNER JOIN `ref` ON `ref`.`id`=`check`.`ref` INNER JOIN `company` ON `company`.`id`=`ref`.`company` WHERE `check`.`status`='1' AND `company`.`name` LIKE '%DSL%' ");
    ...
    public void loadunpaid() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `credit` INNER JOIN `ref` ON `ref`.`id`=`credit`.`ref` INNER JOIN `company` ON `company`.`id`=`ref`.`company` WHERE `credit`.`status`='1' AND `company`.`name` LIKE '%DSL%' ");
    ...
    public void loadpaid() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `credit` INNER JOIN `ref` ON `ref`.`id`=`credit`.`ref` INNER JOIN `company` ON `company`.`id`=`ref`.`company` WHERE `credit`.`status`='2' AND `company`.`name` LIKE '%DSL%' ");
    ...
    public void loadchistoryc() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `credit` INNER JOIN `ref` ON `ref`.`id`=`credit`.`ref` INNER JOIN `company` ON `company`.`id`=`ref`.`company` WHERE `company`.`name` LIKE '%DSL%' ");
    ...
    public void searchsitoryc() {
        ...
        try {
            ...
            if (ccheckno.isEmpty()) {
                ...
                queryVector.add("`credit`.`credit_amount` LIKE '%" + ccheckno + "%' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (shopp.isEmpty()) {
                loadchistoryc();
            } else {
                queryVector.add(" `credit`.`shop_name` LIKE '%" + shopp + "%' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (bill.isEmpty()) {
                loadchistoryc();
            } else {
                queryVector.add(" `credit`.`bill_no` LIKE '%" + bill + "%' AND `company`.`name` LIKE '%DSL%' ");
            }
    ...
    public void searchunpaid() {
        ...
        try {
            ...
            if (ccheckno.isEmpty()) {
                ...
                queryVector.add("`credit`.`credit_amount` LIKE '%" + ccheckno + "%' AND `credit`.`status`='1' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (shopp.isEmpty()) {
                loadunpaid();
            } else {
                queryVector.add(" `credit`.`shop_name` LIKE '%" + shopp + "%' AND `credit`.`status`='1' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (bill.isEmpty()) {
                loadunpaid();
            } else {
                queryVector.add(" `credit`.`bill_no` LIKE '%" + bill + "%' AND `credit`.`status`='1' AND `company`.`name` LIKE '%DSL%' ");
            }
    ...
    public void searchpaid() {
        ...
        try {
            ...
            if (ccheckno.isEmpty()) {
                ...
                queryVector.add("`credit`.`credit_amount` LIKE '%" + ccheckno + "%' AND `credit`.`status`='2' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (shopp.isEmpty()) {
                loadpaid();
            } else {
                queryVector.add(" `credit`.`shop_name` LIKE '%" + shopp + "%' AND `credit`.`status`='2' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (bill.isEmpty()) {
                loadpaid();
            } else {
                queryVector.add(" `credit`.`bill_no` LIKE '%" + bill + "%' AND `credit`.`status`='2' AND `company`.`name` LIKE '%DSL%' ");
            }
    ...
    public void loadbanked() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `check` INNER JOIN `ref` ON `ref`.`id`=`check`.`ref` INNER JOIN `company` ON `company`.`id`=`ref`.`company` WHERE `check`.`status`='2' AND `company`.`name` LIKE '%DSL%' ");
    ...
    public void loadhistory() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `check` INNER JOIN `ref` ON `ref`.`id`=`check`.`ref` INNER JOIN `company` ON `company`.`id`=`ref`.`company` WHERE `company`.`name` LIKE '%DSL%' ");
    ...
    public void searchunbanked() {
        ...
        try {
            ...
            if (ccheckno.isEmpty()) {
                ...
                queryVector.add("`check`.`check_no` LIKE '%" + ccheckno + "%' AND `check`.`status`='1' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (shopp.isEmpty()) {
                loadunbanked();
            } else {
                queryVector.add(" `check`.`shop_name` LIKE '%" + shopp + "%' AND `check`.`status`='1' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (bill.isEmpty()) {
                loadunbanked();
            } else {
                queryVector.add(" `check`.`bill_no` LIKE '%" + bill + "%' AND `check`.`status`='1' AND `company`.`name` LIKE '%DSL%' ");
            }
    ...
    public void searchhistory() {
        ...
        try {
            ...
            if (ccheckno.isEmpty()) {
                ...
                queryVector.add("`check`.`check_no` LIKE '%" + ccheckno + "%' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (shopp.isEmpty()) {
                loadhistory();
            } else {
                queryVector.add(" `check`.`shop_name` LIKE '%" + shopp + "%' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (bill.isEmpty()) {
                loadhistory();
            } else {
                queryVector.add(" `check`.`bill_no` LIKE '%" + bill + "%' AND `company`.`name` LIKE '%DSL%' ");
            }
    ...
    public void searchbanked() {
        ...
        try {
            ...
            if (ccheckno.isEmpty()) {
                ...
                queryVector.add("`check`.`check_no` LIKE '%" + ccheckno + "%' AND `check`.`status`='2' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (shopp.isEmpty()) {
                loadbanked();
            } else {
                queryVector.add(" `check`.`shop_name` LIKE '%" + shopp + "%' AND `check`.`status`='2' AND `company`.`name` LIKE '%DSL%' ");
            }

            if (bill.isEmpty()) {
                loadbanked();
            } else {
                queryVector.add(" `check`.`bill_no` LIKE '%" + bill + "%' AND `check`.`status`='2' AND `company`.`name` LIKE '%DSL%' ");
            }
