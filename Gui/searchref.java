 ...
 * @author Lishan PC
 */
public class searchref extends javax.swing.JFrame {
    ...
    public searchref(dsladdissue ai) {
        initComponents();
        loadrefearch();
    ...
    public void loadrefearch() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `ref` INNER JOIN `company` ON `company`.`id`=`ref`.`company` INNER JOIN `vehicle` ON `vehicle`.`id`=`ref`.`vehicle` WHERE `status_id`='1' AND `company`.`name` LIKE  '%DSL%'; ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchref.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
