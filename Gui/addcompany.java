...
public class addcompany extends javax.swing.JFrame {
    ...
    public addcompany() {
     ...
     public addcompany(DSLhome h) {
        initComponents();
        loadcompany();
        this.h = h;
    }
     
       public addcompany(cyclehome ch) {
        initComponents();
        loadcompany();
        this.ch = ch;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (cname.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Enter Compnany Name", "Warning", JOptionPane.WARNING_MESSAGE);
        } else {
            ...
            try {
                ...
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This Company Already Added!", "Warning", JOptionPane.WARNING_MESSAGE);
                } else {
                    MySQL.iud("INSERT INTO `company`(`name`) VALUES('" + cname + "'); ");

                    loadcompany();
                    h.loadcompany();
                    ch.loadcompany();
                    jTextField1.setText("");
                    JOptionPane.showMessageDialog(this, "Company Added Succesfull!", "Suucess", JOptionPane.INFORMATION_MESSAGE);
