...
public class addvehicle extends javax.swing.JFrame {
    ...
    public addvehicle(DSLhome h) {
        initComponents();
        loadvehicle();
        this.h = h;
    }

    public addvehicle(cyclehome ch) {
        initComponents();
        loadvehicle();
        this.ch = ch;
    }

    public addvehicle(dsladdissue ai) {
        initComponents();
        loadvehicle();
        this.ai = ai;
    }
    ...
    public void loadvehicle() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `vehicle` ORDER BY `id` ASC ; ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (rname.isEmpty()) {
            ...
            try {
                ...
                ResultSet rs = MySQL.search("SELECT * FROM `vehicle` WHERE `number`='" + rname + "' ");

                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This Vehicle Number Already Added!", "Warning", JOptionPane.WARNING_MESSAGE);
                } else {
                    MySQL.iud("INSERT INTO `vehicle`(`number`) VALUES('" + rname + "'); ");
                    ...
                    ch.loadvehicle();
                    jTextField1.setText("");
                    JOptionPane.showMessageDialog(this, "Vehicle Number Added Succesfull!", "Success", JOptionPane.INFORMATION_MESSAGE);
