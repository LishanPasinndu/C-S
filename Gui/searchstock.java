...
public class searchstock extends javax.swing.JFrame {
    ...
    public searchstock(cycleaddissue ci) {
        initComponents();
        loadstock();
        loadcompany();
    ...
    public void loadcompany() {
        ...
        try {
            ...
            ResultSet rs = MySQL.search("SELECT * FROM `ref` INNER JOIN `company` ON `company`.`id`=`ref`.`company` WHERE `status_id`='1' AND `company`.`name` LIKE  '%Cycle%'  ");
    ...
    public void loadstock() {
        ...
        try {
            ...
            ResultSet rs = MySQL.search("SELECT * FROM `stock` INNER JOIN `ref` ON `ref`.`id`=`stock`.`ref` INNER JOIN `product` ON `product`.`id`=`stock`.`product` INNER JOIN `free` ON `free`.`id`=`stock`.`free` WHERE `stock`.`ref`='" + rriid + "' ");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "date", "ref", "code", "product", "qty", "unit price", "Free or Not"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                searchstock vs = new searchstock();
                vs.setVisible(true);
