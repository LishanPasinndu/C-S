...
public class Splash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jProgressBar1.setForeground(new java.awt.Color(176, 203, 196));
        jProgressBar1.setPreferredSize(new java.awt.Dimension(146, 8));
        getContentPane().add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 450, 700, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            InputStream is = Splash.class.getResourceAsStream("/Resources/Gray.theme.json");
